...
# Mean: <a href="https://www.codecogs.com/eqnedit.php?latex=\bar{x}=\frac{1}{n}\sum_{i=1}^n&space;x_i" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\bar{x}=\frac{1}{n}\sum_{i=1}^n&space;x_i" title="\bar{x}=\frac{1}{n}\sum_{i=1}^n x_i" /></a>
